...
import { Home, CheckSquare, Sparkles, Timer, BarChart2, RefreshCw, LogOut } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen w-full flex-col md:flex-row bg-slate-50 dark:bg-black overflow-x-hidden transition-colors duration-300">
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 z-50">
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
          <button
            onClick={logOut}
            className="flex items-center gap-3 px-4 py-3 w-full rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-red-500 transition-all duration-200"
          >
