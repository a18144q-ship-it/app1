...
import { ArrowLeft, QrCode, Scan, Send, Download, Check, X, Wifi, AlertTriangle, Loader2, FileUp, FileDown, Copy, Clipboard, Trash2, LogOut } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-black p-6">
      <header className="flex items-center justify-between mb-8">
        ...
        <button 
          onClick={logOut}
          className="md:hidden flex items-center gap-2 px-3 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors text-sm font-medium"
        >
